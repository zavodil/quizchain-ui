...
Meteor.startup(async () => {
  ...
  if (app.wallet.isSignedIn()) {
    ...
    app.contract = await new Contract(app._account, Meteor.settings.public.nearConfig.contractName, {
      viewMethods: ['get_quiz', 'get_active_quizzes', 'gets_quiz_stats', 'get_game', 'get_distributed_rewards_by_quiz', 'get_answers'],
      changeMethods: ['claim_reward', 'start_game', 'send_answer', 'restart_game', 'create_quiz'],
